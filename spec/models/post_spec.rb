...
RSpec.describe Post, type: :model do
  ...
  it "foodとcalorieがあれば投稿できる" do
    ...
    post = Post.new(id: nil, food: "カレー", calorie: '500', protein: nil, fat: nil, carbo: nil, text: nil, image: nil, created_at: nil, updated_at: nil, user_id: nil, weight: nil, start_time: nil)
