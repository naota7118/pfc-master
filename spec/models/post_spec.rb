...
RSpec.describe Post, type: :model do
  ...
  it "foodとcalorieがあれば投稿できる" do
    ...
    # User.new(id: '1', email: 'sample@sample.com', password: 'abcde')
    ...
    post = build(:post, food: "カレー", calorie: '100', protein: nil, fat: nil, carbo: nil, text: nil, image: nil, created_at: '2020-12-20', updated_at: '2020-12-20', user_id: 1, weight: nil, start_time: '2020-12-20')
